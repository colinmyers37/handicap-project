...
const { getHomePage, getCss, getJs, getCalculator, getRating, getRatingJs, getCalculatorJs, getHandicap, getRatingCss, getAll, createGolfcourse, deleteGolfcourse, updateGolfcourse  } = require('./controller/controller');
